...
(defsystem wxCL
    ...
    :components (:module "clisp-wrappers"
		 ...
		 (:file "wxColourDialog" :depends-on ("wxCL" "wxWindow" "wxDialog" "wxColourData" "wxColour"))
		 ...
		 (:file "wxDialog" :depends-on ("wxCL" "wxWindow" "constants"))
		 ...
		 (:module "wxcl-controls"
			  :depends-on ("clisp-wrappers")
			  :components ((:file "defpackage")
				       (:file "control" :depends-on "defpackage")
				       ...
				       (:file "check-box" :depends-on "control-with-items")))))
